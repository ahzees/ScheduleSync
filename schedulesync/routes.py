...
from schedulesync import employee, occupation, policy, shift, timetable
...
routes.include_router(policy.router, prefix="/policy")
routes.include_router(timetable.router, prefix="/timetable")
